...
CREATE TABLE pizza_runner.customer_orders (
  ...
  customer_id INTEGER,
  pizza_id INTEGER,
  exclusions STRING(4), --maybe better stored as an array in bq
  extras STRING(4), --maybe better stored as an array in bq
...
CREATE TABLE pizza_runner.runner_orders (
  ...
  distance STRING(7), --this should be an integer called distance_km
  duration STRING(10), --this should be an integer called duration_sec 
